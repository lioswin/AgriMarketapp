...
import AgriMarketlogo from "../../assets/logo/logo_white2.png";
        ...
        <View style={styles.container}>
            ...
            <View style={styles.topBarContainer}>
                ...
                <View style={styles.topbarlogoContainer}>
                    <Image source={AgriMarketlogo} style={styles.logo} />
                    <Text style={styles.toBarText}>AgriMarket</Text>
                </View>
                <TouchableOpacity
                ...
                >
                    ...
                    <View style={styles.cartItemCountContainer}>
                        <Text style={styles.cartItemCountText}>0</Text>
                    </View>
